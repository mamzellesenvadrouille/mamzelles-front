...
async function main() {
  ...
  if (male) {
    ...
    const restosMale = [
      { nom: "The Sea House", cuisine: "Fruits de mer, vue sur l'océan", prix: "€€" as const, lat: 4.1898, lng: 73.5295 },
      { nom: "Sala Thai Restaurant", cuisine: "Thaïlandais", prix: "€€" as const, lat: 4.1770, lng: 73.5108 },
      { nom: "Mr. Octopus", cuisine: "Fruits de mer, italien", prix: "€€" as const, lat: 4.1748, lng: 73.5091 },
      { nom: "Seagull Café", cuisine: "Petit-déjeuner, desserts", prix: "€" as const, lat: 4.1735, lng: 73.5085 },
      { nom: "Symphony Restaurant", cuisine: "Chinois, fruits de mer", prix: "€€€" as const, lat: 4.1741, lng: 73.5099 },
    ];
    // Vrais sites et activités existants à Malé
    const activitesMale = [
      { nom: "Marché aux poissons de Malé", description: "Marché traditionnel très animé, la vraie vie locale", lat: 4.1746, lng: 73.5088 },
      { nom: "Grande Mosquée du Vendredi (Hukuru Miskiy)", description: "Mosquée en pierre de corail du 17e siècle", lat: 4.1752, lng: 73.5097 },
      { nom: "Musée National des Maldives", description: "Collection d'objets royaux et historiques", lat: 4.1759, lng: 73.5104 },
      { nom: "Sultan Park", description: "Ancien jardin royal, havre de verdure en pleine ville", lat: 4.1757, lng: 73.5102 },
      { nom: "Monument du Tsunami", description: "Mémorial en hommage aux victimes de 2004", lat: 4.1720, lng: 73.5145 },
    ];
