// scripts/ajouter-checklist-voyage-palawan.ts
// À placer dans : /Users/lauriemelaye/Desktop/mamzelles-front/scripts/ajouter-checklist-voyage-palawan.ts
//
// Ajoute la checklist voyage de base au carnet Palawan (créé avant que
// cette fonctionnalité existe, donc jamais préremplie automatiquement).
//
// Usage : npx tsx --env-file=.env.local scripts/ajouter-checklist-voyage-palawan.ts
