      ...
      <div className="article-layout article-portbarton">
        <main className="article-main">
          ...
          <section id="manille" className="article-section">
            ...
            <p>Nous avons pris un hôtel à 10 minutes de l’aéroport car notre prochain vol est le lendemain vers 13h. Pour 30€ la nuit, petit-déjeuner compris, l'<strong><a href="https://maps.google.com/maps?q=place_id:ChIJK8bbvLLOlzMRYbFvStoscYI" target="_blank" rel="noopener noreferrer" className="article-link">Achievers Airport Hotel</a></strong> est top. Si, comme nous, vous êtes juste de passage pour une nuit à Manille, nous vous recommandons vivement cet hôtel. Il est possible de vous arranger avec eux pour organiser les transferts aéroport &lt;—&gt; hôtel, qui sont gratuits.</p>
          ...
          <section id="puerto-princesa" className="article-section">
            ...
            <p>138 Php (2€30) pour rejoindre notre hôtel, le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJUcV-c9pjtTMRqPc9JvcSG6w" target="_blank" rel="noopener noreferrer" className="article-link">Puerto Pension Inn</a></strong>, à une dizaine de minutes de l’aéroport. C’est plutôt correct ! Nous y passerons 4 nuits. Comptez 28€ par nuit, petit-déjeuner compris.</p>
            ...
            <p>Pour le dîner, nous mangeons aux <strong><a href="https://maps.google.com/maps?q=place_id:ChIJR1rkzeZjtTMRLCOn0T2aPBQ" target="_blank" rel="noopener noreferrer" className="article-link">Artisans</a></strong>, une bonne adresse où l’on mange de bons plats frais et savoureux.</p>
            <div className="article-day-header article-day-header-tight">
...
C’est parti, nous sommes 8 sur le bateau.</p>
            ...
            <p>Aujourd’hui, nous quittons notre petit havre de paix pour passer une dernière nuit à Puerto Princesa, mais dans un autre hôtel. Nous sommes attendues et invitées par le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ73SI9OhjtTMRYXrgxfkk_Uw" target="_blank" rel="noopener noreferrer" className="article-link">Canvas Boutique Hotel</a></strong>.</p>
            ...
            <p>Avec son design contemporain et toutes ses œuvres d’art locales, le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ73SI9OhjtTMRYXrgxfkk_Uw" target="_blank" rel="noopener noreferrer" className="article-link">Canvas Boutique Hotel</a></strong> est canon en tout cas.
...
On enfile les maillots de bain, direction la piscine, histoire de se rafraîchir et de se prélasser au bord de l’eau.</p>
            <p>Après ce moment détente, on se prépare pour aller manger. On a repéré un petit restaurant méditerranéen à seulement 3 minutes à pied qui nous tente bien, le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJfQAWwkBjtTMR5OWg6iaA4y8" target="_blank" rel="noopener noreferrer" className="article-link">Bersian Restaurant</a></strong>. Effectivement, on s’est régalées.</p>
          ...
          <section id="sabang" className="article-section">
            ...
            <p>Comme nous sommes un peu en avance, on y laisse nos gros sacs pour aller rapidement manger un bout. On a repéré à deux pas de là, un petit restaurant super bien noté sur Google, le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJcZF3PnRjtTMRm36ng_dELj0" target="_blank" rel="noopener noreferrer" className="article-link">Ka Inato</a></strong>.</p>
...
<h4>⧐ De retour sur la terre ferme...</h4>
            ...
            <p>Quand on se retrouve une heure plus tard, Laurie est dans un état de décontraction intense ! On décide alors de rentrer tranquillement à l’hôtel. Rincées de cette journée, on dînera et on profitera de cette dernière soirée au <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ_x7gtZqRtTMRPvYphSR6oqs" target="_blank" rel="noopener noreferrer" className="article-link">Bambua Nature Cottage</a></strong>.</p>
            <div className="article-gallery-2">
          ...
          <section id="port-barton" className="article-section">
            ...
            <p>On rejoint notre petit chez nous pour les 6 prochaines nuits en tuk-tuk, à l’<a href="https://maps.google.com/maps?q=place_id:ChIJLTS1b9PEtTMRutNFDX2fHaw" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Aquarius Hôtel</strong></a>. Pour tout le séjour, nous payons 10,360 Php (165€). Le petit-déjeuner n'est pas inclus. En revanche, le café et l’eau filtrée sont à disposition en permanence. Cet hôtel est tenu par une mère et sa fille. Elles sont tellement gentilles, on se sent rapidement comme en famille.</p>
            <p>Il fait déjà nuit quand nous partons en vadrouille, direction la plage. On avait repéré un petit bar restaurant, pieds dans le sable, le <a href="https://maps.google.com/maps?q=place_id:ChIJhWAoNADFtTMRqMaERqTX7hQ" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Barton Bistro</strong></a><em>…</em> 100 Php (1,60€) la bière et 500 Php (8€) la pizza. Les prix sont un peu plus élevés qu’à Puerto Princesa, ce qui est normal puisqu’on est plus isolées ici. En tout cas, on s’est régalées. On a tellement hâte de découvrir le paysage de jour…</p>
            ...
            <p>On est allées manger au <a href="https://maps.google.com/maps?q=place_id:ChIJoXIQr7fFtTMR13irWqld-OU" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Flow Bar</strong></a> le midi, un restaurant-bar piscine. Leurs burgers et leurs pizzas sont incroyables ! Pour info, vous avez la possibilité de commander un verre et de profiter de la piscine toute la journée si vous le souhaitez.</p>
            <p>Fin de journée sur la plage et coucher de soleil au <a href="https://maps.google.com/maps?q=place_id:ChIJMRbvbNPEtTMRbQVLDQeWwj0" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Mai Tai</strong></a>. L’endroit est vraiment agréable et les cocktails y sont très bons !</p>
            <div className="article-gallery-2">
...
Notre hôtel nous prête un kayak… Nous voilà parties pour rejoindre White Beach à la rame !</p>
            ...
            <p>Pour finir la journée en beauté, nous retrouvons une locale au <a href="https://maps.google.com/maps?q=place_id:ChIJMRbvbNPEtTMRbQVLDQeWwj0" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Mai Tai</strong></a>, avec qui le courant est tout de suite bien passé. Elle nous présente à plein de gens de son entourage, locaux et expatriés.</p>
            ...
            <p>Nous avons rendez-vous à 9h à côté du <strong><a href="https://maps.google.com/maps?q=place_id:ChIJhWAoNADFtTMRqMaERqTX7hQ" target="_blank" rel="noopener noreferrer" className="article-link">Barton Bistro</a></strong>. On paye 1500 Php (24€) par personne, soit 1300 Php + 200 Php d’éco-taxe. Pas de prise de tête à savoir avec qui il faut réserver, c’est le même prix partout. Pour notre excursion, nous sommes directement passées par un local que nous avons rencontré quelques jours plus tôt sur la plage.</p>
          ...
          <section id="san-vicente" className="article-section">
            ...
            <p>Nous partons en direction du <strong>village d'Alimanguan</strong> pour manger. On a repéré un hôtel-restaurant sur la plage qui nous tente bien. Avec ses paillotes et ses tables en bois sur la plage, <strong><a href="https://maps.google.com/maps?q=place_id:ChIJg2drqix5tjMRyRfCIANEurI" target="_blank" rel="noopener noreferrer" className="article-link">The Turtle Beach Resort &amp; Restaurant</a></strong> est très chill.</p>
            ...
            <p>Aujourd'hui, direction la <strong>Long Beach</strong> en scooter, avec pour objectif d’aller manger au <strong><a href="https://maps.google.com/maps?q=place_id:ChIJB3tH_R_WtTMRLtgAG_9Jk8k" target="_blank" rel="noopener noreferrer" className="article-link">Club Agutaya</a></strong>.</p>
            ...
            <p>On décide alors de continuer notre chemin. On tombe par hasard sur <strong><a href="https://maps.google.com/maps?q=place_id:ChIJLSAHXJh5tjMRWd9JI1U9g8Y" target="_blank" rel="noopener noreferrer" className="article-link">The Hotel Elizabeth</a></strong>. Pensées pour notre fourgon aménagé qui porte le même nom, on décide de s’y arrêter.</p>
            ...
            <p>À 12h15, départ en scooter, et comme prévu la veille, direction le<strong> <a href="https://maps.google.com/maps?q=place_id:ChIJB3tH_R_WtTMRLtgAG_9Jk8k" target="_blank" rel="noopener noreferrer" className="article-link">Club Agutaya</a></strong>. À peine entrées, c’est un gros Wahoo ! Cet hôtel est juste incroyable !</p>
...
On profite un bon quart d'heure de ce décor de rêve avant de repartir vers l'hôtel.</p>
            ...
            <p>De retour sur la terre ferme et après une douche rapide, on boucle nos bagages. Bye bye l’<strong><a href="https://maps.google.com/maps?q=place_id:ChIJQ0HVc4jXtTMRT_e6wLA8YXM" target="_blank" rel="noopener noreferrer" className="article-link">Acuario Beach Inn</a></strong> ! On a un petit pincement au cœur en partant… On y était tellement bien !</p>
            <p>Direction le <a href="https://maps.google.com/maps?q=place_id:ChIJg2drqix5tjMRyRfCIANEurI" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Mango Bar</strong></a> au port de San Vicente pour déjeuner. Au menu, un crabe fraîchement pêché pour Laurie (390 Php, soit 6€40) et un demi-poulet frit pour Amélie (260 Php, soit 4€25).</p>
          ...
          <section id="retour-port-barton" className="article-section">
            ...
            <p>Pour notre nouveau séjour, nous allons cette fois-ci à <strong><a href="https://maps.google.com/maps?q=place_id:ChIJvX6uVf7WtTMRh6WRU6srGF0" target="_blank" rel="noopener noreferrer" className="article-link">Ausan Beach Cottages and Restaurant</a></strong>. L’hôtel est sur la plage. Et ça tombe bien, le taxi-boat nous débarque juste devant ! En réalité, on serait bien retournées à l’<strong><a href="https://maps.google.com/maps?q=place_id:ChIJLTS1b9PEtTMRutNFDX2fHaw" target="_blank" rel="noopener noreferrer" className="article-link">Acuarius</a></strong>, mais il était complet à cette période.
Via le site <strong>Agoda</strong> (très utilisé pour les réservations d’hôtels aux Philippines), nous avons payé 10,320 Php (170€) pour 5 nuits, petits-déjeuners compris.</p>
            <p>Nous nous installons dans notre joli cottage et partons au <strong><a href="https://maps.google.com/maps?q=place_id:ChIJMRbvbNPEtTMRbQVLDQeWwj0" target="_blank" rel="noopener noreferrer" className="article-link">Mai Tai</a></strong>, pour l'apéro sunset.</p>
            <p>On dînera ensuite au <a href="https://maps.google.com/maps?q=place_id:ChIJYas4sEbFtTMRdlVfkkXG06s" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Star Apple Canteen</strong></a>. C’est qu’on commence à avoir nos petites habitudes ici ! Bref, une fin de journée comme on les aime.</p>
            <div className="article-gallery-2">
            ...
            <p>Pour le déjeuner, direction le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ1TtGrtfEtTMRFfbhGIiYYBI" target="_blank" rel="noopener noreferrer" className="article-link">Mojito Bar</a></strong> qui se trouve à une quinzaine de minutes à pied de la plage de Port Barton. Ambiance jardin tropical, l’endroit est agréable et apaisant. Leurs mini-burgers sont incroyables, et les mojitos excellents !</p>
            ...
            <p>Le salon s’appelle <strong><a href="https://maps.google.com/maps?q=place_id:ChIJD07s07DbtTMRbe9JXSp9HCI" target="_blank" rel="noopener noreferrer" className="article-link">Hynails services</a></strong>. La nana est très appliquée et les produits sont de bonne qualité. Le tarif est de 500 Php (8€) pour une pose de vernis semi-permanent. C’est franchement très correct ! Bref, vous pouvez y aller les yeux fermés.</p>
            <h4>⧐ On se fait tatouer !</h4>
            <p>La journée est déjà presque terminée, mais on a encore un petit truc à faire… Nous avons rendez-vous au <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ2epK4CvFtTMRXOXaZW-5OOo" target="_blank" rel="noopener noreferrer" className="article-link">Rebel Art Tattoo Kollectiv</a></strong>. Et oui, impossible de résister à l’idée de se faire tatouer en souvenir de ce merveilleux voyage !</p>
            ...
            <p>Repas du soir à <strong><a href="https://maps.google.com/maps?q=place_id:ChIJKwFJctPEtTMR__RL1YxXisw" target="_blank" rel="noopener noreferrer" className="article-link">Kusinero del Barrio</a></strong>, l’un de nos restaurants préférés à Port Barton.</p>
            <div className="article-gallery-3">
            ...
            <p>Ce midi, nous allons déjeuner au <a href="https://maps.google.com/maps?q=place_id:ChIJ5zlib7vEtTMRS9KJ2L8ZFCc" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Jungle Bar Resto &amp; Cottages</strong></a>. Pour le rejoindre, il faut compter 30 minutes de tuk-tuk sur une route bien chaotique. Il faut en fait emprunter la même route que pour aller à White Beach. Il y a des panneaux en chemin pour indiquer l’endroit… Si vous voyez « Don’t worry, beer happy », c’est par là ! Pour info, prévoir entre 500 et 600 Php (entre 8 et 10€) pour le trajet Aller-Retour.</p>
            <p>Le <a href="https://maps.google.com/maps?q=place_id:ChIJ5zlib7vEtTMRS9KJ2L8ZFCc" target="_blank" rel="noopener noreferrer" className="article-link"><strong>Jungle Bar</strong></a> est tenu par Sandrine, une Française expatriée depuis une dizaine d'années. On y découvre de jolis cottages avec une vue imprenable sur la baie. Le lieu est calme, idéal pour se reposer et profiter de la nature.</p>
            <div className="article-gallery-2">
            ...
            <p>Après un moment de détente, cap sur la plage privée <strong><a href="https://maps.google.com/maps?q=place_id:ChIJp07PcgDbtTMRaCHIxOjihxU" target="_blank" rel="noopener noreferrer" className="article-link">Gilligans</a></strong>, un autre endroit paradisiaque.</p>
          ...
          <section id="au-revoir" className="article-section">
            ...
            <p>Vu l’heure tardive à laquelle nous arrivons, le chauffeur nous dépose directement à l’hôtel. Pour notre dernière nuit sur Palawan, nous dormons au <strong><a href="https://maps.google.com/maps?q=place_id:ChIJ3_jFmNljtTMR5f9jG6X6HBU" target="_blank" rel="noopener noreferrer" className="article-link">Mariner’s Pension House</a></strong>.</p>
            <p>Il se situe plus ou moins dans le même quartier que le <strong><a href="https://maps.google.com/maps?q=place_id:ChIJUcV-c9pjtTMRqPc9JvcSG6w" target="_blank" rel="noopener noreferrer" className="article-link">Puerto Pension Inn</a></strong>. Le petit truc en plus, c’est la piscine. Nous avons payé 1,720 Php (28 €) pour la nuit, petit-déjeuner compris.</p>
            <div className="article-gallery-2">
            ...
            <p>Nous arrivons à Manille pour la dernière nuit de notre séjour. Une toute petite nuit, car demain, nous devons être à l’aéroport à 3h30 ! Nous avons réservé à l'<strong><a href="https://maps.google.com/maps?q=place_id:ChIJK8bbvLLOlzMRYbFvStoscYI" target="_blank" rel="noopener noreferrer" className="article-link">Achievers Airport Hotel</a></strong> (le même qu’à l’aller). Ce qui est top avec cet hôtel, c’est que les transferts sont inclus dans le tarif.</p>
