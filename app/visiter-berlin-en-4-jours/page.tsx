          ...
          <section id="jour-1-prenzlauer-berg" className="article-section">
            ...
            <div className="article-tip-with-gallery">
              <div className="article-tip-with-gallery-row">
                ...
                <div><strong className="article-tip-with-gallery-title">Bon à savoir</strong><p>L’hôtel est installé dans un ancien bain public du début des années 1900, à une époque où beaucoup d’appartements n’avaient pas encore de salle de bain. Fermé en 1986, il est resté abandonné pendant des décennies avant une restauration monumentale. Aujourd’hui, le joyau de l’hôtel Oderberger, c’est son bassin <strong style={{whiteSpace: 'nowrap'}}>néo-Renaissance</strong>, avec ses mosaïques, ses colonnes, et surtout sa verrière.</p></div>
              </div>
