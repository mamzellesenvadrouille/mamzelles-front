      ...
      <div className="article-layout article-berlin">
        <main className="article-main">
          ...
          <section id="jour-1-prenzlauer-berg" className="article-section">
            ...
            <p>Nous poursuivons ensuite vers <strong>Kollwitzplatz</strong>, une charmante place au cœur de Prenzlauer Berg. Ici, l’ambiance est plus douce. C’est une place arborée, il y a quelques espaces verts, des terrasses pleines de vie et on y trouve de jolies façades tout autour. Entre cafés, restaurants et familles berlinoises installées sur les bancs ou dans le petit parc, on découvre un Berlin plus calme, presque un esprit de village au cœur de la ville. Attention, allergiques s’abstenir. On a rarement autant de pollen au mètre carré qu’ici !</p>
            <h3>Mitte</h3>
