      ...
      <div className="article-layout article-berlin">
        <main className="article-main">
          ...
          <section id="jour-2-berlin-est" className="article-section">
            ...
            <p>Après ce moment suspendu, à une vingtaine de minutes de marche, se trouve un lieu impossible à manquer quand on visite Berlin : la East Side Gallery. C’est en fait le plus long tronçon encore debout du mur de Berlin, transformé aujourd’hui en immense galerie d’art à ciel ouvert.</p>
            ...
            <p>Nous continuons notre parcours découverte, et à même pas 15 minutes à pied de là, se trouve le RAW-Gelände. C’est un immense ancien site industriel reconverti, dans le quartier de Friedrichshain.</p>
