      ...
      <div className="article-layout article-berlin">
        <main className="article-main">
          ...
          <section id="jour-1-prenzlauer-berg" className="article-section">
            ...
            <p>Nous sommes parties à 8h du matin. Ma femme m’a fait croire que nous prenions la voiture pour deux heures de route, mais en réalité, elle avait tout prévu. Direction la gare d’Antibes. Nous montons dans le train, cap vers l’Italie, sans que je sache encore où nous allons. En arrivant à la gare Saint-Augustin, je comprends enfin : nous allons prendre l’avion. Une fois à l’aéroport, elle me révèle la destination surprise en m’offrant le guide de Berlin. Une annonce aussi inattendue qu’excitante. C’est parti pour quatre jours et trois nuits dans une ville qui allait nous surprendre bien plus que nous l’imaginions.</p>
            <p>Une fois arrivées à l’aéroport de Berlin, il faut encore rejoindre le centre-ville. Direction le terminal 1 pour prendre le train S-Bahn vers la gare centrale, la Hauptbahnhof (HBF). Comptez 5 € par personne pour un ticket valable deux heures, largement suffisant pour rejoindre le centre.</p>
            ...
            <p>Il est 15 heures, on n’a toujours pas mangé. On se dirige vers l’hôtel mais sur le chemin pour y aller, premier arrêt gourmand obligatoire à Rüyam Gemüse Kebab, une véritable institution à Berlin. Ma femme m’en avait parlé il y a quelques jours et moi je n’avais rien capté ! Ici, on ne parle pas d’un kebab classique. Leur spécialité, le Gemüse Kebab. Un mélange de viande grillée, de légumes rôtis (pomme de terre, poivrons…), de crudités ultra fraîches, de fromage type feta et surtout leurs sauces maison à l’ail et épicée, le tout dans un pain croustillant.</p>
            ...
            <p>Kebab avalé, nous poursuivons notre chemin vers l’hôtel. Nous sommes dans le quartier de Prenzlauer Berg et c’est là que se trouve notre hôtel.</p>
            ...
            <div className="article-tip">
              ...
              <div><strong>Pour l’histoire et la culture</strong><p>L’hôtel est installé dans un ancien bain public historique transformé en hôtel 4 étoiles, dans ce quartier branché de Prenzlauer Berg. Le lieu ouvre au début des années 1900, pour offrir des bains aux habitants, à une époque où beaucoup d’appartements n’avaient pas encore de salle de bain. Il fermera en 1986, puis restera abandonné pendant des décennies avant une restauration monumentale. Aujourd’hui, son gros atout c’est la piscine néo-Renaissance dans l’ancienne halle de natation. Des personnes y viennent spécialement pour passer quelques heures à la piscine et son sol peut même être transformé pour accueillir des événements (soirée privée, mariage, défilé, shooting photo ou tournage…).</p></div>
            </div>
            <div className="article-resto">
              <div className="article-resto-item">
                <div className="article-resto-head">
            ...
            <p>Non loin de là, nous prenons la direction du Wasserturm de Prenzlauer Berg, le plus ancien château d’eau de Berlin, construit au XIXe siècle. Véritable symbole du quartier, il veille sur les jolies rues résidentielles environnantes et apporte une ambiance plus calme, presque village, au cœur de la ville. Juste derrière, un petit parc. Comme des gosses, un petit tour de tourniquet et c’est reparti !</p>
            <div className="article-tip">
              <span className="article-tip-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" strokeWidth="1.5"><path d="M12 2a7 7 0 00-4 12.74V17a1 1 0 001 1h6a1 1 0 001-1v-2.26A7 7 0 0012 2z"/><line x1="9" y1="21" x2="15" y2="21"/><line x1="10" y1="23" x2="14" y2="23"/></svg></span>
