...
const destinations = [
  ...
  },
  {
    pays: 'Asie',
    liens: [
      { label: 'Itinéraire Philippines', href: 'https://blog.mamzellesenvadrouille.com/itineraire-philippines-3-semaines-pour-decouvrir-la-perle-de-lorient/' },
      { label: 'Palawan – El Nido & Coron', href: 'https://blog.mamzellesenvadrouille.com/palawan-entre-el-nido-coron-decouvrez-le-joyau-des-philippines/' },
      { label: 'Palawan – Port Barton', href: 'https://blog.mamzellesenvadrouille.com/palawan-de-puerto-princesa-a-port-barton-hors-des-sentiers-battus/' },
    ]
  },
];
