      ...
      <div className="article-newsletter">
        ...
        <div className="article-newsletter-inner">
          <div className="article-newsletter-text">
            ...
            <p>À chaque nouvel article publié, nos itinéraires,<br className="tablet-only" /> bonnes adresses et coups de cœur<br className="tablet-only" /> directement dans votre boîte mail.</p>
          </div>
