            ...
            <div className="article-day-header">
              ...
              <div className="article-gallery-2">
                ...
                <div className="pb-resto-card pb-riad-card">
                  ...
                  <span className="pb-resto-card-desc" style={{color:"rgba(26,21,18,0.65)",fontSize:"11px"}}>150 Dh accès piscine — repas à la carte en supplément.</span>
                </div>
                <div className="pb-resto-card pb-riad-card">
                  <span className="pb-resto-card-name">
                  ...
                  <span className="pb-resto-card-desc" style={{color:"rgba(26,21,18,0.65)",fontSize:"11px"}}>À partir de 400 Dh (piscine + déjeuner).</span>
                </div>
              </div>
              <div className="pb-resto-grid" style={{gridTemplateColumns:'repeat(2,1fr)',marginBottom:'28px'}}>
                <div className="pb-resto-card pb-riad-card">
                  ...
                  <span className="pb-resto-card-desc" style={{color:"rgba(26,21,18,0.65)",fontSize:"11px"}}>250 Dh accès piscine + déjeuner.</span>
                </div>
                <div className="pb-resto-card pb-riad-card">
                  <span className="pb-resto-card-name">
                  ...
                  <span className="pb-resto-card-desc" style={{color:"rgba(26,21,18,0.65)",fontSize:"11px"}}>290 Dh accès piscine + déjeuner.</span>
                </div>
              </div>
              <div className="article-gallery-2">
