      ...
      <div className="article-layout article-philippines">
        <main className="article-main">
          ...
          <section className="article-section">
            <p className="article-intro"><strong>Vous envisagez de partir à la découverte des Philippines et vous cherchez l&apos;itinéraire parfait ? Vous êtes au bon endroit ! Nous vous partageons ici le nôtre en détail.<br />Belle lecture à vous et bon voyage !<i className="ti ti-plane" aria-hidden="true" style={{color: 'var(--gold)', fontSize: '18px', verticalAlign: 'middle', marginLeft: '6px', marginRight: '4px'}}></i><i className="ti ti-beach" aria-hidden="true" style={{color: 'var(--gold)', fontSize: '18px', verticalAlign: 'middle'}}></i></strong></p>
