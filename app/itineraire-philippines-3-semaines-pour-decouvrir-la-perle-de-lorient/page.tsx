      ...
      <div className="article-layout article-philippines">
        <main className="article-main">
          ...
          <section id="palawan" className="article-section">
            ...
            <a href="/palawan-entre-el-nido-coron-decouvrez-le-joyau-des-philippines" style={{display:"block", margin:"24px 0"}}><img src="/related/Palawan-article.webp" alt="Palawan Blog" className="article-img-full" loading="lazy" /></a>
          ...
          {/* ARTICLES LIES */}
          <ArticlesLies currentSlug="itineraire-philippines-3-semaines-pour-decouvrir-la-perle-de-lorient" />
