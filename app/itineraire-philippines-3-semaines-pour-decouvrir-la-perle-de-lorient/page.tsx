          ...
          <section id="budget" className="article-section">
            ...
            <div className="article-pratique-grid" style={{marginBottom: '32px'}}>
              <div className="article-pratique-card">
                <h3 style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-plane" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Vols internationaux</h3>
              ...
              <div className="article-pratique-card">
                <h3 style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-bus" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Transports sur place</h3>
              ...
              <div className="article-pratique-card">
                <h3 style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-bed" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Hébergements</h3>
              ...
              <div className="article-pratique-card">
                <h3 style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-tools-kitchen-2" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Repas &amp; Activités</h3>
            ...
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', margin: '8px 0 32px'}}>
              <div style={{textAlign: 'center', padding: '24px 16px', background: 'var(--bg)', border: '1px solid var(--line)', borderRadius: '8px'}}>
                <p style={{fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', color: '#8a847e', margin: '0 0 12px'}}>Économique</p>
              ...
              <div style={{textAlign: 'center', padding: '24px 16px', background: '#fdf4ee', border: '1px solid var(--gold)', borderRadius: '8px'}}>
                <p style={{fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', color: 'var(--gold)', margin: '0 0 12px'}}>Moyen</p>
                <p style={{fontFamily: "'Cormorant Garamond', serif", fontSize: '28px', fontWeight: 600, color: 'var(--dark)', margin: '0 0 4px'}}>1 600€ – 2 200€</p>
                <p style={{fontSize: '12px', color: '#8a847e', margin: 0}}>par personne</p>
              </div>
              <div style={{textAlign: 'center', padding: '24px 16px', background: 'var(--bg)', border: '1px solid var(--line)', borderRadius: '8px'}}>
                <p style={{fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', color: '#8a847e', margin: '0 0 12px'}}>Confortable</p>
