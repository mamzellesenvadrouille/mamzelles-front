...
export const metadata: Metadata = {
  title: "Itinéraire Philippines 3 semaines : découvrir la perle de l'Orient | MamZelles en vadrouille",
    ...
    <div style={{ width: '100%', overflowX: 'hidden' }}>
      ...
      <section className="hero hero-article" style={{ overflowX: 'hidden' }}>
        ...
        <div className="hero-content">
          ...
          <p className="hero-desc">Notre itinéraire détaillé pour explorer les Philippines en 3 semaines,<br className="hide-mobile-br" />entre îles de rêve, rizières en terrasse, cascades et rencontres inoubliables.</p>
        </div>
      </section>
      ...
      <div className="article-coup-de-coeur">
        ...
        <div className="article-cdcr-grid">
          ...
          <div className="article-cdcr-item"><span className="article-cdcr-label">La surprise de taille</span><span className="article-cdcr-value">→ Les lucioles sur la rivière Loboc à Bohol</span></div>
          <div className="article-cdcr-item"><span className="article-cdcr-label">Notre meilleur souvenir</span><span className="article-cdcr-value">→ Le poulet curry avec vue panoramique à Batad</span></div>
        </div>
      </div>
        ...
        <main className="article-main">
          ...
          <nav className="article-toc">
            ...
            <ol className="article-toc-list">
              ...
              <li><a href="#siquijor">📍 Siquijor, l&apos;île mystique </a></li>
          ...
          <section className="article-section">
            <p className="article-intro"><strong>Vous envisagez de partir à la découverte des Philippines et vous cherchez l&apos;itinéraire parfait ? Vous êtes au bon endroit ! Nous vous partageons ici le nôtre en détail.</strong></p>
            <p><strong>Belle lecture à vous et bon voyage ! ✈️🏝️</strong></p>
            ...
            <p>Vouloir découvrir un maximum d&apos;endroits sous-entend pas mal de déplacements pour rejoindre les différentes îles en avion et/ou en ferry.</p>
            <p>Durant notre voyage, nous avons rencontré plusieurs personnes qui ont fait le choix de ne rien planifier et de voir au fur et à mesure où ils souhaitaient se rendre.</p>
          ...
          <section id="banaue" className="article-section">
            ...
            <p>Nous arrivons à l&apos;heure du petit déjeuner, parfait après ce long trajet en bus ! Nous nous installons à la terrasse de l&apos;hôtel pour déguster leur incroyable pancake au coulis de chocolat et prendre un café.</p>
            <p>C&apos;est à ce moment-là qu&apos;un membre du personnel se joint à nous et nous présente tout ce qu&apos;il y a à voir, à faire dans le coin.</p>
            <p>Nous organisons directement avec lui nos deux prochaines journées… <strong>Jour 1, trek à Batad, et Jour 2, visite d&apos;Hapao et de ses Hot springs.</strong></p>
            <p>Pour deux personnes et les excursions des deux jours, nous payons <strong>10 800 Php (173€)</strong>, transport privé et guide compris.</p>
            <h4>⧐ Banaue</h4>
            ...
            <h4>⧐ Batad ou la 8ème Merveille du monde !</h4>
            ...
            <p>Alors que dans le reste du pays le riz est cultivé et récolté 2 fois par an, ici à Batad, c&apos;est seulement une fois dans l&apos;année, soit en février. <strong>Le meilleur moment pour venir voir les rizières en terrasse à Batad est donc au mois de mai.</strong> C&apos;est juste avant la récolte, quand tout est bien vert.</p>
            ...
            <p>Après avoir bien profité de ce moment, nous retrouvons notre guide pour rebrousser chemin.</p>
            <p>C&apos;est parti pour remonter les <strong>700 marches, et la pente est assez raide !</strong> Ce sont les mollets qui en prennent un coup… Mais franchement, aucun regret. Nous sommes tellement heureuses de l&apos;avoir fait. <strong>« I survived Batad ! »,</strong> comme on dit ici.</p>
            ...
            <p>À Hapao, les locaux cultivent également du café, du poivre, des tomates et des courgettes.</p>
            <p>En tout cas, ce village est très joli et les couleurs sont incroyables. Contrairement à Batad où ce n&apos;était pas vraiment la meilleure période, ici toutes les terrasses sont déjà bien vertes.</p>
            <div className="article-gallery-2">
            ...
            <p>Une légère odeur de soufre se dégage de cet endroit. N&apos;oublions pas que les Philippines sont sur des terres volcaniques.</p>
          ...
          <section id="bohol" className="article-section">
            ...
            <p>Il est environ 12h30 quand nous arrivons à l&apos;aéroport de Bohol. Nous avions anticipé et organisé le transfert avec notre hôtel. Nous avons payé <strong>1500 Php (25€)</strong> pour <strong>aller de la presqu&apos;île de Panglao,</strong> où se trouve l&apos;aéroport, <strong>à notre hébergement qui se situe au bord de la Loboc River.</strong></p>
            <p><strong>Il faut compter 1h de route pour ce trajet.</strong> Vous avez également la possibilité de prendre une jeepney, les bus de ville ou les tricycles. Au vu de notre arrivée sous la pluie, on a bien fait de prévoir le taxi, certes plus cher, mais plus confort et plus rapide !</p>
            ...
            <p>Nous avons choisi de séjourner à l&apos;hôtel <strong><a href="https://www.booking.com/hotel/ph/water-to-forest-ecolodge.fr.html" target="_blank" rel="noopener noreferrer" className="article-link">Water to Forest Ecolodge</a></strong>. Pour y accéder, sur les derniers kilomètres, nous empruntons un chemin de terre qui longe la rivière. Bon là, avec la pluie qui est tombée, on est plutôt sur un chemin de boue !</p>
            <div className="article-gallery-2">
            ...
            <p>Objectif de la journée, aller à la découverte de ces petits plus qu&apos;abritent l&apos;île de Bohol… <strong>On a prévu une boucle d&apos;environ 120 km, soit plus ou moins 3h30 de route.</strong></p>
            ...
            <h4>⧐ Baclayon church, ou l&apos;Église de corail</h4>
            ...
            <p>Nous repartons déjà demain et devrons quitter l&apos;hôtel à 13h pour nous rendre au port de Tagbilaran. Notre passage à Bohol était court mais on en a pris plein les yeux ! Nous profitons de cette dernière nuit au beau milieu de la jungle.</p>
          ...
          <section id="siquijor" className="article-section">
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 1</span>
              <h3>Jour 1 - Arrivée à Siquijor après 2h de ferry</h3>
            </div>
            ...
            <p>Nous prenons un <strong>tuk-tuk directement à la sortie du quai,</strong> direction l&apos;hôtel <strong><a href="https://www.booking.com/hotel/ph/charisma-beach-resort.fr.html?aid=318615&amp;label=New_English_EN_FR_21457884505-T0t%2AedlXm_oGkIMqMNUhEAS217291026622%3Apl%3Ata%3Ap1%3Ap2%3Aac%3Aap%3Aneg&amp;sid=25689103515261a10f95ba7b9dc4b06e&amp;dest_id=-2453627;dest_type=city;dist=0;group_adults=2;group_children=0;hapos=1;hpos=1;no_rooms=1;req_adults=2;req_children=0;room1=A%2CA;sb_price_type=total;sr_order=popularity;srepoch=1728470705;srpvid=52a44b9544840705;type=total;ucfs=1&amp;" target="_blank" rel="noopener noreferrer" className="article-link">Charisma beach</a></strong>. <strong>Tous les tuk-tuks sont aux mêmes tarifs pour les mêmes trajets. </strong></p>
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 2</span>
              <h3>Jour 2 - Journée pluvieuse...</h3>
            </div>
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 3</span>
              <h3>Jour 3 - Après la pluie, le beau temps</h3>
            </div>
            ...
            <div className="article-day-header">
              ...
              <h3>Jour 4 - Nouvelle journée, nouvelles aventures !</h3>
            </div>
            ...
            <p>Arrivées à Bohol, nous avons 3h devant nous avant notre prochain ferry. On en profite pour aller faire un petit tour en ville.</p>
          </section>
          ...
          <section id="cebu" className="article-section">
            ...
            <h4>Jour 1 - Réveil à Cebu et direction Siargao !</h4>
          ...
          <section id="siargao" className="article-section">
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 1</span>
              <h3>Jour 1 - Arrivée sous la pluie sur l&apos;île aux cocotiers</h3>
            </div>
            <p><strong>En arrivant de Cebu, nous avions seulement 1h de vol. Si vous arrivez de manille, il y a un peu plus de 2h de vol.  </strong></p>
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 2</span>
              <h3>Jour 2 - De la pluie, de la pluie, encore de la pluie !</h3>
            </div>
            ...
            <h4>~ Où faire la fête à Siargao ? ➢Harana Surf Resort</h4>
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 3</span>
              <h3>Jour 3 - Il fait beau. À nous l&apos;Island hopping !</h3>
            </div>
            ...
            <h4>~ Où se faire tatouer à Siargao ? ➢Rad Tattoo</h4>
            ...
            <h4>~ Où faire la fête à Siargao ? ➢Mad Monkey</h4>
            ...
            <div className="article-day-header">
              <span className="article-day-badge">Jour 4</span>
              <h3>Jour 4 - Direction le Nord de Siargao avant le grand retour !</h3>
            </div>
          ...
          <section id="budget" className="article-section">
            <div className="article-day-header">
              <h2>☞ ITINÉRAIRE 3 SEMAINES : QUEL BUDGET ? ☜</h2>
            </div>
            ...
            <h4>✈️ - Billets d&apos;avion internationaux</h4>
            ...
            <h4>✈️🚌⛴️ - Déplacements aux Philippines</h4>
          ...
          <section id="pratique" className="article-section">
            ...
            <p>⋙ <strong>L&apos;eau du robinet n&apos;étant pas potable,</strong> consommez seulement l&apos;eau en bouteille ou l&apos;eau filtrée. Si vous sortez un peu des sentier battus, <strong>évitez les glaçons et les aliments crus,</strong> favorisez les aliments bien cuit. On peut considérer qu&apos;il y a moins de risques de contamination dans les hôtels et endroits touristiques.</p>
            <p>⋙ Nous vous conseillons fortement de <strong>prendre une trousse à pharmacie</strong> en cas de problème car on ne trouve pas forcément tout ce dont on a besoin sur place : anti-diarrhéique, antiseptique, anti-inflammatoire, crème solaire, antibiotiques pour les possibles infections intestinales...</p>
            <div className="article-day-header">
              <h3>~ Loisirs</h3>
            </div>
            <p>⋙ <strong>Si vous souhaitez louer un scooter, pensez à prendre votre permis de conduite.</strong> Les scooters mis en location sont des 125CC. Ce n&apos;est pas systématique, mais sur certaines îles, on vous recommande de l&apos;avoir en cas de contrôle de police. Dans certains hôtels, on vous demande également le numéro du permis. À titre informatif, nous n&apos;avons jamais été contrôlées.</p>
            <p>⋙ Prévoir des chaussons pour marcher dans l&apos;eau ou des tongs qui tiennent aux pieds (ça fait aussi bien l&apos;affaire).</p>
            <p>⋙ Indispensable selon nous, emportez un sac waterproof pour protéger vos affaires (téléphone, drone, clés, portefeuille…) lors des Island hoppings. En arrivant sur certaines îles, vous êtes parfois débarqués à quelques mètres du bord de la plage qu&apos;il faut rejoindre à la nage.</p>
            <div className="article-day-header">
              <h3>~ Météo</h3>
            </div>
            <p><strong>Le climat des Philippines est principalement tropical,</strong> il fait chaud toute l&apos;année. Cependant, il y a trois saisons distinctes : la saison tempérée de décembre à février, la saison sèche de mars à mai, et enfin, la saison des pluies de juin à novembre. Dans l&apos;ensemble, <strong>la meilleure période pour découvrir les Philippines se situe entre janvier et avril. </strong>Normalement, vous éviterez les grosses pluies et les chaleurs insoutenables.</p>
            <p>Nous avions décidé de partir 3 semaines en février pour s&apos;assurer d&apos;une belle météo. Pour autant, même les locaux n&apos;avaient jamais vu de telles précipitations à la période où nous y étions... Nous avons reçu à plusieurs reprises des messages sur nos téléphones pour nous alerter des inondations, des glissements de terrain... Plutôt angoissant de recevoir ce genre de message en vacances !</p>
            ...
            <p>⋙ <strong>Ne vous chargez pas avec trop de vêtements. </strong>Vous aurez la possibilité de les laver sur place. Tous les hôtels proposent un service de laundry pour <strong>100 Php (1€60)</strong> le kilo en moyenne. Votre sac sera moins lourd pour vous déplacer et vous aurez plus de place pour ramener des souvenirs.</p>
            <p>⋙ <strong>On vous conseille de jeter un oeil sur des groupes Facebook tels que </strong>"les francophones aux Philippines (tout sauf la météo)" ou "les français aux Philippines"... Vous y trouverez beaucoup d&apos;infos utiles et pratiques pour votre séjour.</p>
            ...
            <p><em><strong>Si vous avez des questions, ou que vous souhaitez nous partager un retour d&apos;expérience, n&apos;hésitez pas à nous la</strong><strong>isser un commentaire, à nous contacter via le </strong><strong><a href="https://mamzellesenvadrouille.com/formulaire-de-contact/" target="_blank" rel="noopener noreferrer" className="article-link">formulaire de contact</a> ou notre compte <a href="https://www.instagram.com/mamzellesenvadrouille/" target="_blank" rel="noopener noreferrer" className="article-link">Instagram</a>.</strong></em></p>
        ...
        <aside className="article-sidebar">
          ...
          <div className="sidebar-card sidebar-cta">
            ...
            <div className="sidebar-cta-body">
              <h3 className="sidebar-cta-title">Vous rêvez d&apos;un voyage<br className="mobile-only" /> <em>sur mesure ?</em></h3>
              <p className="sidebar-cta-text">Nous créons des itinéraires personnalisés, pensés selon vos envies, votre rythme<br className="mobile-only" /> et votre budget.</p>
