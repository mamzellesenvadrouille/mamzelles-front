      ...
      <div className="article-layout article-philippines">
        <main className="article-main">
          ...
          <section className="article-section">
            <p className="article-intro"><strong>Vous envisagez de partir à la découverte des Philippines et vous cherchez l&apos;itinéraire parfait ? Vous êtes au bon endroit ! Nous vous partageons ici le nôtre en détail.<br />Belle lecture à vous et bon voyage ! ✈️🏝️</strong></p>
            ...
            <p>Vouloir découvrir un maximum d&apos;endroits sous-entend pas mal de déplacements pour rejoindre les différentes îles en avion et/ou en ferry.<br />
            Durant notre voyage, nous avons rencontré plusieurs personnes qui ont fait le choix de ne rien planifier et de voir au fur et à mesure où ils souhaitaient se rendre.</p>
            ...
            <p>Le fait d&apos;<strong>anticiper les réservations</strong> laisse moins de place aux plans galères et aux mauvaises surprises.<br />
          ...
          <section id="banaue" className="article-section">
            ...
            <p>Le bus s&apos;arrête 3 fois sur le trajet dans des sortes de stations services. Pauses pipi ! Ah oui, il n&apos;y a pas de toilette dans le bus !<br />
            Durant ces pauses qui dégourdissent les jambes et qui réchauffent aussi, vous trouverez également de quoi grignoter (biscuits, chips, boissons chaudes et fraîches…).</p>
            ...
            <p>À Hapao, les locaux cultivent également du café, du poivre, des tomates et des courgettes.<br />
            En tout cas, ce village est très joli et les couleurs sont incroyables. Contrairement à Batad où ce n&apos;était pas vraiment la meilleure période, ici toutes les terrasses sont déjà bien vertes.</p>
            <div className="article-gallery-2">
          ...
          <section id="bohol" className="article-section">
            ...
            <div className="article-tip">
              <span className="article-tip-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" strokeWidth="1.5"><path d="M12 2a7 7 0 00-4 12.74V17a1 1 0 001 1h6a1 1 0 001-1v-2.26A7 7 0 0012 2z"/><line x1="9" y1="21" x2="15" y2="21"/><line x1="10" y1="23" x2="14" y2="23"/></svg></span>
              <div><strong>Le saviez-vous ?</strong><p>Tout autour de vous, étendues sur 50 km², se dressent près de 1 780 collines, mesurant entre 30 et 60 mètres de hauteur. À noter : un panneau interdit de faire voler son drone à partir de 8h du matin.</p></div>
            </div>
