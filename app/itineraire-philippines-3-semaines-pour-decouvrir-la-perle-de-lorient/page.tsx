          ...
          <section id="budget" className="article-section">
            ...
            <div className="article-pratique-grid" style={{marginBottom: '32px'}}>
              <div className="article-pratique-card">
                <h3 className="budget-h3" style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-plane" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Vols internationaux</h3>
              ...
              <div className="article-pratique-card">
                <h3 className="budget-h3" style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-bus" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Transports sur place</h3>
              ...
              <div className="article-pratique-card">
                <h3 className="budget-h3" style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-bed" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Hébergements</h3>
              ...
              <div className="article-pratique-card">
                <h3 className="budget-h3" style={{display:"flex",alignItems:"center",gap:"10px",fontSize:"24px"}}><i className="ti ti-tools-kitchen-2" aria-hidden="true" style={{fontSize:"26px",color:"var(--gold)",flexShrink:0}}></i>Repas &amp; Activités</h3>
