      ...
      <div className="article-layout">
        <main className="article-main">
          ...
          <section id="jour3" className="article-section">
            ...
            <p>Si par hasard vous avez la chance d&apos;être à Madrid le 2ème week-end du mois, vous ne pourrez pas louper le <strong>Mercado de Motores</strong>. Situé dans l&apos;ancienne <strong>gare de Delicias</strong>, le marché accueille de nombreux artisans, créateurs, designers et brocanteurs. Du rétro, du vintage, de l&apos;artisanat, des objets d&apos;occasion, tout y est ! Vous apprécierez déambuler sur les quais et admirer les wagons et locomotives du XIXème siècle. Nous avons trouvé cet endroit plutôt original et de toute beauté ! À l&apos;extérieur, notamment le long de la gare, quelques stands de brocanteurs ainsi que des food trucks vous feront de l&apos;oeil. Ces derniers sont peu nombreux mais tous sont alléchants. En choisir un pour manger sur le pouce ne sera pas chose facile !</p>
            ...
            <div className="article-transport-grid">
              ...
              <div className="article-transport-item">
                ...
                <div>
                  ...
                  <span>5,10€ · 40 min · 24h/24. Attention : de 23h55 à 5h35, départ depuis la Plaza de Cibeles (et non la gare Puerta de Atocha).</span>
                </div>
              </div>
              <div className="article-transport-item">
                <div className="article-transport-icon">
