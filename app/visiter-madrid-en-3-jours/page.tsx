        ...
        <main className="article-main">
          ...
          <section id="jour1" className="article-section">
            ...
            <div className="article-gallery-2">
              <img src="https://blog.mamzellesenvadrouille.com/wp-content/uploads/2022/01/IMG_2446-scaled-1024x768.jpeg" alt="Palais Royal Madrid" loading="lazy" style={{objectPosition: '0% center'}} />
