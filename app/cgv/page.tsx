  ...
  return (
    <div style={{ width: '100%', overflowX: 'hidden', overflowY: 'visible' }}>
      ...
      <section style={{ maxWidth: '720px', margin: '0 auto', padding: '56px 24px 80px', fontFamily: 'Inter, sans-serif', color: 'var(--dark)', lineHeight: '1.8', fontSize: '15px' }}>
        ...
        <p>Le carnet de voyage interactif personnalisé est préparé dans un délai de 15 jours ouvrés à compter de la réception de l&rsquo;acompte et de l&rsquo;ensemble des informations nécessaires fournies par le client (dates, préférences, budget, etc.). Le carnet de voyage est transmis par email sous la forme d&rsquo;un lien d&rsquo;accès personnel, dès réception du solde. Si le solde est réglé après l&rsquo;issue de ce délai de 15 jours, la transmission intervient dès sa réception.</p>
        ...
        <p>En cas de litige, une solution amiable sera recherchée en priorité en contactant <a href="mailto:contact@mamzellesenvadrouille.com" style={{ color: 'var(--gold)' }}>contact@mamzellesenvadrouille.com</a>. À défaut d&rsquo;accord, les présentes CGV sont régies par le droit français. Les juridictions compétentes seront déterminées conformément aux règles de droit applicables.</p>
