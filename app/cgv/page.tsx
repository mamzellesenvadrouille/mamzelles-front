  ...
  return (
    <div style={{ width: '100%', overflowX: 'hidden' }}>
      ...
      <section style={{ maxWidth: '720px', margin: '0 auto', padding: '56px 24px 80px', fontFamily: 'Inter, sans-serif', color: 'var(--dark)', lineHeight: '1.8', fontSize: '15px' }}>
        ...
        <p>Le carnet de voyage interactif personnalisé est transmis par email, sous forme d&rsquo;un lien d&rsquo;accès personnel, sous 15 jours ouvrés à compter de l&rsquo;acceptation du devis. Ce délai suppose la réception de l&rsquo;acompte et de l&rsquo;ensemble des informations nécessaires fournies par le client (dates, préférences, budget, etc.).</p>
